    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <div class="clearfix"></div>
                <form class="form-horizontal form-label-left" action="/dev/flatform/app/appinfoaddsave" method="post" enctype="multipart/form-data">
                    <div class="item form-group">
...
<script src="${pageContext.request.contextPath}/statics/localjs/appinfoadd.js" type="text/javascript"></script>